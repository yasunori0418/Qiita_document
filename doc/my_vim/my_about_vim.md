...
そして調べ物をするときに、マウスを使ってだらだらと「あーでもない、こーでもない」という操作は理解できます。
...
そうやって試行錯誤を繰り返して、自分が使いやすいようにカスタマイズしていくのがShougo氏のプラグインの良さであり、いわゆる「闇の力」と呼ばれる物を体験することになるのです。
...
|vim-lsp|上記の2つはNeoVimである必要がありますが、こちらはVimでも導入できます。<br>ただVim-Scriptで作られているため、上記2つには速度では負けてしまいます。<br>こちらも別に補完プラグインを導入する必要があります。    |
...
今回書いた内容は、本当に大筋のみで、この記事を書くための必要な環境まで、詳細には書いていません。
